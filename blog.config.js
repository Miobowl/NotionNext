...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到 Miobowl 的书房',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://miobowl.com', // 网站地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,weibo,email,facebook,twitter,telegram,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Miobowl 的书房', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎来到 Miobowl 的书房', // 站点描述，被notion中的页面描述覆盖
